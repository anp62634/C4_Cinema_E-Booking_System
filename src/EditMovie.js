            ...
            <div className="auth">
                <form className="form">
                    <div className="input-group">
                        ...
                        <input type="text" name="movie-category" placeholder={movie.description} required/>
                        <label htmlFor="movie-showdate">Movie Show Date</label>
                        <input type="text" name="movie-director" placeholder={movie.showDate[0]} required/>
                        <label htmlFor="movie-showtime">Movie Show Time</label>
                        <input type="text" name="movie-director" placeholder={movie.showTime[0]} required/>
                    </div>
